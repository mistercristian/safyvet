...
<div class="container mt-5">
    <h1 class="text-center mb-4 custom-tittle">Agregar Productos </h1>
    ...
    <form method="POST" action="{{route('productos.store')}}" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="name" aria-describedby="nameHelp" name="name" placeholder="Nombre producto" value="">
        ...
        <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="stock" aria-describedby="nameHelp" name="stock"  value="">

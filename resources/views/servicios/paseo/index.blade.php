...
<x-app-layout>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card" style="width: 100%;">
                    <img src="{{ asset('img/servicios/paseo_actividad.jpg') }}" class="card-img-top"
                        alt="Paseo de Actividad" style="height: 200px; object-fit: cover;">
                    <div class="card-body">
                        <div class="d-flex justify-content-center">
                            <h5 class="card-title">Paseo de Actividad</h5>
                        </div>
                        <div class="d-flex justify-content-center">
                            <p class="card-text">Un paseo lleno de energía y actividad para que tu mascota se mantenga
                                en forma y saludable.</p>
                        </div>
                        <br>
                        <div class="d-flex justify-content-center">
            ...
            <div class="col-md-4">
                <div class="card" style="width: 100%;">
                    <img src="{{ asset('img/servicios/paseo_social.jpg') }}" class="card-img-top"
                        alt="Paseo de Socialización" style="height: 200px; object-fit: cover;">
                    <div class="card-body">
                        <div class="d-flex justify-content-center">
                            <h5 class="card-title">Paseo de Socialización</h5>
                        </div>
                        <div class="d-flex justify-content-center">
                            <p class="card-text">Diseñado para que tu mascota socialice con otros perros y personas en
            ...
            <div class="col-md-4">
                <div class="card" style="width: 100%;">
                    <img src="{{ asset('img/servicios/paseo_ocio.jpg') }}" class="card-img-top" alt="Paseo de Ocio"
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-center">
                            <p class="card-text">Un paseo relajado para que tu mascota disfrute del aire libre y explore
                                su entorno a su propio ritmo.</p>
                        </div>
                        <br>
                        <div class="d-flex justify-content-center">
    ...
    <div class="container mt-5">
        ...
        <div id="paseo-actividad" class="row align-items-center mb-5">
            ...
            <div class="col-md-4">
                <img src="{{ asset('img/servicios/paseo_actividad.jpg') }}" alt="Servicio de Paseo de Actividad"
                    class="img-fluid rounded">
            </div>

            <div class="col-md-8">
                <h2>Paseo de Actividad</h2>
                <p>El Paseo de Actividad está diseñado para mantener a tu mascota en forma, ofreciendo un recorrido
                    lleno de ejercicios y juegos. Ideal para perros activos que necesitan gastar energía.</p>
        ...
        <div id="paseo-socializacion" class="row align-items-center mb-5">
            ...
            <div class="col-md-4">
                <img src="{{ asset('img/servicios/paseo_social.jpg') }}" alt="Servicio de Paseo de Socialización"
                    class="img-fluid rounded">
            </div>

            <div class="col-md-8">
                <h2>Paseo de Socialización</h2>
                <p>El Paseo de Socialización permite a tu mascota interactuar con otros perros y personas, favoreciendo
                    su comportamiento y confianza en entornos sociales.</p>
        ...
        <div id="paseo-ocio" class="row align-items-center mb-5">
            ...
            <div class="col-md-4">
                <img src="{{ asset('img/servicios/paseo_ocio.jpg') }}" alt="Servicio de Paseo de Ocio"
                    class="img-fluid rounded">
            </div>

            <div class="col-md-8">
                <h2>Paseo de Ocio</h2>
                <p>El Paseo de Ocio es perfecto para mascotas que disfrutan de un ritmo más tranquilo. Este servicio se
                    enfoca en la exploración y relajación en un ambiente natural.</p>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <p>Tu paseo ha sido solicitado correctamente. Nos pondremos en contacto contigo para confirmar los
                        detalles.</p>
                </div>

        ...
        <div class="col-md-4">
            <div class="card" style="width: 100%;">
                ...
                <div class="card-body">
                    ...
                    <br>
                    <div class="d-flex justify-content-center">
                        <button onclick="showGardenModal('Reino de Roma')" class="btn btn-warning">Comprar</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card" style="width: 100%;">
                ...
                <div class="card-body">
                    ...
                    <br>
                    <div class="d-flex justify-content-center">
                        <button onclick="showGardenModal('Comederos')" class="btn btn-warning">Comprar</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card" style="width: 100%;">
                ...
                <div class="card-body">
                    ...
                    <br>
                    <div class="d-flex justify-content-center">
                        <button onclick="showGardenModal('Pet House')" class="btn btn-warning">Comprar</a>
                    </div>
                </div>
            </div>
        </div>
